...
describe('Services :: ArmorsServices', () => {
  ...
  describe('When the recover a armor by ID service is called', () => {
    beforeAll(() => {
      jest.spyOn(ArmorsModelMock, 'findOne').mockResolvedValueOnce(armorMockInstance)
  ...
  describe('When service for update a armor is called', () => {
    ...
    beforeAll(() => {
      jest.spyOn(ArmorsModelMock, 'update').mockResolvedValueOnce(armorMockUpdateInstance)
        .mockResolvedValue(null);
    });
