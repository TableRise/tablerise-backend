...
import { InjectNewDungeonsAndDragonsClasses } from 'tests/support/dataInjector';
import requester from 'tests/support/requester';

const ENTITY_ID = 'aaaabbbb-0003-4000-8000-000000000003';
const BASE_PATH = '/system/dnd5e/classes';

describe('When managing D&D 5e Classes', () => {
    let model: any;

    before(async () => {
        model = new DatabaseManagement().modelInstance('dungeons&dragons5e', 'Classes');
        await model.erase();
        const [cls] = DomainDataFakerDD.generateDungeonsAndDragonsJSON({
            count: 1,
            entity: 'classes',
            entityId: ENTITY_ID,
        });
        await InjectNewDungeonsAndDragonsClasses(cls);
    });
    ...
    context('And all data is correct', () => {
        ...
        it('should toggle class availability to disabled', async () => {
        ...
        it('should return all disabled classes', async () => {
