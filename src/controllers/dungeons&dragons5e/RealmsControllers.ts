import { DnDRealm, Internacional } from '@tablerise/database-management';
...
export default class RealmsControllers {
    ...
    public async findAllDisabled(_req: Request, res: Response): Promise<Response> {
        this._logger('warn', 'Request [findAllDisabled] made to realms');
    ...
    public async update(req: Request, res: Response): Promise<Response> {
        ...
        const { id: _id } = req.params;
        const payload = req.body as Internacional<DnDRealm>;
    ...
    public async updateAvailability(req: Request, res: Response): Promise<Response> {
        this._logger('warn', 'Request [updateAvailability] made to realms');
        const { id: _id } = req.params;
