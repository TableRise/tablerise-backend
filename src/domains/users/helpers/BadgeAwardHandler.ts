...
export const CAMPAIGN_BADGE_RULES = [
    { counter: 'campaignsJoinedAmount', amount: 2, badge: 'enthusiast' },
    { counter: 'campaignsJoinedAmount', amount: 5, badge: 'student' },
    { counter: 'campaignsJoinedAmount', amount: 10, badge: 'mage' },
    { counter: 'campaignsJoinedAmount', amount: 30, badge: 'necromant' },
    { counter: 'campaignsJoinedAmount', amount: 50, badge: 'dragon' },
    { counter: 'campaignsCreatedAmount', amount: 2, badge: 'cleric' },
    { counter: 'campaignsCreatedAmount', amount: 5, badge: 'high_cleric' },
    { counter: 'campaignsCreatedAmount', amount: 10, badge: 'sorcerer' },
    { counter: 'campaignsCreatedAmount', amount: 30, badge: 'high_sorcerer' },
    { counter: 'campaignsCreatedAmount', amount: 50, badge: 'supreme_sorcerer_cleric' },
    { counter: 'campaignsClosedAmount', amount: 2, badge: 'warrior' },
    { counter: 'campaignsClosedAmount', amount: 5, badge: 'warrior_young' },
    { counter: 'campaignsClosedAmount', amount: 10, badge: 'warrior_arcane' },
    { counter: 'campaignsClosedAmount', amount: 30, badge: 'warrior_darkness' },
    { counter: 'campaignsClosedAmount', amount: 50, badge: 'warrior_ancient' },
    { counter: 'equipBoughtAmount', amount: 10, badge: 'imp' },
    { counter: 'equipBoughtAmount', amount: 30, badge: 'imp_rich' },
    { counter: 'equipBoughtAmount', amount: 50, badge: 'imp_very_rich' },
