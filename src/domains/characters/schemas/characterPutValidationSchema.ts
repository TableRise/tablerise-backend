...
const appearanceCharacterZodSchema = z
    .object({
...
const otherCharacterZodSchema = z
    .object({
...
const characteristicsCharacterZodSchema = z
    .object({
...
const profileCharacterZodSchema = z
    .object({
...
const hitPointsCharacterZodSchema = z
    .object({
...
const deathSavesCharacterZodSchema = z
    .object({
...
const spellCastingCharacterZodSchema = z
    .object({
        class: z.string().optional(),
...
const statsCharacterZodSchema = z
    .object({
...
const moneyCharacterZodSchema = z
    .object({
...
const dataCharacterZodSchema = z
    .object({
