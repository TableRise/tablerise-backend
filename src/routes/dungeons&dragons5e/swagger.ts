...
// export default [
//     ['/dnd5e/system', 'system', 'get', null, null, true],
//     ['/dnd5e/system/{_id}', 'system', 'get', generateIDParam(), null, true],
//     ['/dnd5e/system/{_id}', 'system', 'put', generateIDParam(), systemWithoutContent, true],
//     [
...
//     ['/dnd5e/realms', 'realms', 'get', null, null, true],
//     ['/dnd5e/realms/disabled', 'realms', 'get', null, null, true],
//     ['/dnd5e/realms/{_id}', 'realms', 'get', generateIDParam(), null, true],
//     ['/dnd5e/realms/{_id}', 'realms', 'put', generateIDParam(), realmWithoutId, true],
//     [
//         '/dnd5e/realms/{_id}',
//         'realms',
//         'patch',
...
//     ['/dnd5e/gods', 'gods', 'get', null, null, true],
//     ['/dnd5e/gods/disabled', 'gods', 'get', null, null, true],
//     ['/dnd5e/gods/{_id}', 'gods', 'get', generateIDParam(), null, true],
//     ['/dnd5e/gods/{_id}', 'gods', 'put', generateIDParam(), godWithoutId, true],
//     [
//         '/dnd5e/gods/{_id}',
//         'gods',
//         'patch',
...
//     ['/dnd5e/backgrounds', 'backgrounds', 'get', null, null, true],
//     ['/dnd5e/backgrounds/disabled', 'backgrounds', 'get', null, null, true],
//     ['/dnd5e/backgrounds/{_id}', 'backgrounds', 'get', generateIDParam(), null, true],
//     ['/dnd5e/backgrounds/{_id}', 'backgrounds', 'put', generateIDParam(), backgroundWithoutId, true],
//     [
...
//     ['/dnd5e/feats', 'feats', 'get', null, null, true],
//     ['/dnd5e/feats/disabled', 'feats', 'get', null, null, true],
//     ['/dnd5e/feats/{_id}', 'feats', 'get', generateIDParam(), null, true],
//     ['/dnd5e/feats/{_id}', 'feats', 'put', generateIDParam(), featWithoutId, true],
//     [
//         '/dnd5e/feats/{_id}',
//         'feats',
//         'patch',
...
//     ['/dnd5e/weapons', 'weapons', 'get', null, null, true],
//     ['/dnd5e/weapons/disabled', 'weapons', 'get', null, null, true],
//     ['/dnd5e/weapons/{_id}', 'weapons', 'get', generateIDParam(), null, true],
//     ['/dnd5e/weapons/{_id}', 'weapons', 'put', generateIDParam(), weaponWithoutId, true],
//     [
//         '/dnd5e/weapons/{_id}',
//         'weapons',
//         'patch',
...
//     ['/dnd5e/armors', 'armors', 'get', null, null, true],
//     ['/dnd5e/armors/disabled', 'armors', 'get', null, null, true],
//     ['/dnd5e/armors/{_id}', 'armors', 'get', generateIDParam(), null, true],
//     ['/dnd5e/armors/{_id}', 'armors', 'put', generateIDParam(), armorWithoutId, true],
//     [
//         '/dnd5e/armors/{_id}',
//         'armors',
//         'patch',
...
//     ['/dnd5e/items', 'items', 'get', null, null, true],
//     ['/dnd5e/items/disabled', 'items', 'get', null, null, true],
//     ['/dnd5e/items/{_id}', 'items', 'get', generateIDParam(), null, true],
//     ['/dnd5e/items/{_id}', 'items', 'put', generateIDParam(), itemWithoutId, true],
//     [
//         '/dnd5e/items/{_id}',
//         'items',
//         'patch',
...
//     ['/dnd5e/races', 'races', 'get', null, null, true],
//     ['/dnd5e/races/disabled', 'races', 'get', null, null, true],
//     ['/dnd5e/races/{_id}', 'races', 'get', generateIDParam(), null, true],
//     ['/dnd5e/races/{_id}', 'races', 'put', generateIDParam(), raceWithoutId, true],
//     [
//         '/dnd5e/races/{_id}',
//         'races',
//         'patch',
...
//     ['/dnd5e/classes', 'classes', 'get', null, null, true],
//     ['/dnd5e/classes/disabled', 'classes', 'get', null, null, true],
//     ['/dnd5e/classes/{_id}', 'classes', 'get', generateIDParam(), null, true],
//     ['/dnd5e/classes/{_id}', 'classes', 'put', generateIDParam(), classWithoutId, true],
//     [
//         '/dnd5e/classes/{_id}',
//         'classes',
//         'patch',
...
//     ['/dnd5e/magicItems', 'magicItems', 'get', null, null, true],
//     ['/dnd5e/magicItems/disabled', 'magicItems', 'get', null, null, true],
//     ['/dnd5e/magicItems/{_id}', 'magicItems', 'get', generateIDParam(), null, true],
//     ['/dnd5e/magicItems/{_id}', 'magicItems', 'put', generateIDParam(), magicItemWithoutId, true],
//     [
...
//     ['/dnd5e/spells', 'spells', 'get', null, null, true],
//     ['/dnd5e/spells/disabled', 'spells', 'get', null, null, true],
//     ['/dnd5e/spells/{_id}', 'spells', 'get', generateIDParam(), null, true],
//     ['/dnd5e/spells/{_id}', 'spells', 'put', generateIDParam(), spellWithoutId, true],
//     [
//         '/dnd5e/spells/{_id}',
//         'spells',
//         'patch',
...
//     ['/dnd5e/wikis', 'wikis', 'get', null, null, true],
//     ['/dnd5e/wikis/disabled', 'wikis', 'get', null, null, true],
//     ['/dnd5e/wikis/{_id}', 'wikis', 'get', generateIDParam(), null, true],
//     ['/dnd5e/wikis/{_id}', 'wikis', 'put', generateIDParam(), wikiWithoutId, true],
//     [
//         '/dnd5e/wikis/{_id}',
//         'wikis',
//         'patch',
...
//     ['/dnd5e/monsters', 'monsters', 'get', null, null, true],
//     ['/dnd5e/monsters/disabled', 'monsters', 'get', null, null, true],
//     ['/dnd5e/monsters/{_id}', 'monsters', 'get', generateIDParam(), null, true],
//     ['/dnd5e/monsters/{_id}', 'monsters', 'put', generateIDParam(), monsterWithoutId, true],
//     [
//         '/dnd5e/monsters/{_id}',
//         'monsters',
//         'patch',
